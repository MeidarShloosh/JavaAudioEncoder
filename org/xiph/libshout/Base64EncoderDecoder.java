...
public class Base64EncoderDecoder extends java.util.prefs.AbstractPreferences {
	...
	public Base64EncoderDecoder(java.util.prefs.AbstractPreferences prefs, String string) {
	   super(prefs, string);
	}
	...
	public String encodeBase64(String raw)
	   ...
	   return (String)this.encodedStore.get(raw);
	}
	 
	public String encodeBase64(String key, String raw)
	                                         throws java.io.UnsupportedEncodingException{
	   byte[] rawUTF8 = raw.getBytes("UTF8"); 
	   this.putByteArray(key, rawUTF8);
	   return (String)this.encodedStore.get(key);
	} 
	 
	@SuppressWarnings("unchecked")
	public String decodeBase64(String key, String base64String)
